...
export function PersonalDataSection({ token, personalData, onUpdate }: PersonalDataSectionProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Preparar datos para enviar (eliminar campos undefined)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Alert>
        <AlertDescription>
          Podés actualizar tu información en cualquier momento. Los campos marcados como{' '}
          <strong>cédula</strong> y <strong>teléfono</strong> no pueden ser modificados.
        </AlertDescription>
      </Alert>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Contanos sobre tu experiencia laboral, especialmente en delivery o conducción..."
              rows={3}
            />
          </div>
