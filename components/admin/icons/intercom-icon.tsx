// components/admin/icons/intercom-icon.tsx
// Icono oficial de Intercom (color de marca #1F8DED preservado).
// Compatible con la signature de lucide-react: acepta props de SVGSVGElement.
