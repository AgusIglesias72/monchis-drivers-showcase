        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent transition-colors"
                  style={{
                    ['--tw-ring-color' as any]: MONCHIS_RED
                  }}
                  onFocus={(e) => {
                    e.currentTarget.style.borderColor = MONCHIS_RED
                  }}
                  onBlur={(e) => {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent transition-colors"
                  style={{
                    ['--tw-ring-color' as any]: MONCHIS_RED
                  }}
                  onFocus={(e) => {
            ...
            <button
              ...
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#c51d35'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = MONCHIS_RED}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 space-y-2">
            <div className="text-center text-sm">
              <Link
                ...
                onMouseEnter={(e) => e.currentTarget.style.color = '#c51d35'}
                onMouseLeave={(e) => e.currentTarget.style.color = MONCHIS_RED}
              >
